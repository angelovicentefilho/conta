...
_transaction_service = TransactionServiceImpl(
    _transaction_repository, _category_repository, _account_repository
)
    ...
    try:
        transaction = await transaction_service.create_transaction(
            ...
            recurrence_frequency=(
                ...
                if transaction_data.recurrence_frequency
                else None
            ),
        )
        ...
        return TransactionResponse(
            ...
            category_name=(
                category.name if category else "Categoria não encontrada"
            ),
        ...
        for transaction in transactions:
            ...
            result.append(
                TransactionSummaryResponse(
                    id=transaction.id,
                    account_name=(
                        account.name if account else "Conta não encontrada"
                    ),
                    category_name=(
                        category.name
                        if category
