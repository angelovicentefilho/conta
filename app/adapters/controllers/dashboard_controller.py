...
def get_dashboard_service() -> DashboardServicePort:
    ...
    return DashboardServiceImpl(
        account_repo, transaction_repo, category_repo, analytics_service
    )
...
async def get_dashboard_balance(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Erro ao obter saldo do dashboard: {
                str(e)}",
        )
...
async def get_dashboard_summary(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Erro ao obter resumo do dashboard: {
                str(e)}",
        )
...
async def get_dashboard_expenses_by_category(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Erro ao obter despesas por categoria: {
                str(e)}",
        )
...
async def get_dashboard_balance_evolution(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Erro ao obter evolução de saldos: {
                str(e)}",
        )
...
async def get_dashboard_recent_transactions(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Erro ao obter transações recentes: {
                str(e)}",
        )
...
async def get_dashboard_indicators(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Erro ao obter indicadores: {str(e)}"
        )
