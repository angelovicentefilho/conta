...
class TestSettings:
    ...
    def test_test_mongodb_url_with_db_property(self):
        ...
        settings = Settings()
        expected_url = f"{
            settings.test_mongodb_url}/{settings.test_mongodb_database}"
    ...
    def test_secret_key_validation(self):
        ...
        with pytest.raises(
            ValueError, match="SECRET_KEY deve ter pelo menos 32 caracteres"
        ):
    ...
    def test_environment_variables_override(self):
        ...
        assert (
            settings.secret_key == "production-secret-key-32-characters-long"
        )
